...
public class Message {
    ...
    public Message(int messageID, String sender, String messageBody, Date messageDate) {
    ...
    //     return messageID == message.messageID && Objects.equals(sender, message.sender) && Objects.equals(messageBody, message.messageBody) && Objects.equals(messageDate, message.messageDate);
    // }
